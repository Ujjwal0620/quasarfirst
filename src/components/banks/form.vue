<template>
  <div clas="column">
    ...
    <q-form ref="form" class="q-gutter-md">
      ...
      <br />
      <q-input
        :rules="[validationMandatory, validationNoSymbols]"
        dense
        label="Bank Name"
        outlined
      ...
      />
      <br />
      <q-input dense label="IFSC" outlined v-model="formData.ifsc" />
      <br />
      <q-input dense label="Branch" outlined v-model="formData.Branch" />
      <br />
      <q-select
        dense
